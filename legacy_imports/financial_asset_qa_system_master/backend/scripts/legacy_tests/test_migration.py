...
rag_files = [
    ...
    "app/experimental/rag/grounded_pipeline.py",
    "app/experimental/rag/fact_verifier.py",
    "app/experimental/rag/hybrid_retrieval.py",
    "app/experimental/rag/ultimate_pipeline.py",
    "app/experimental/rag/bge_embedding.py",
    "app/experimental/rag/enhanced_document_parser.py",
    "app/experimental/rag/enhanced_data_pipeline.py",
]

all_exist = True
for file in rag_files:
    exists = (BACKEND_ROOT / file).exists()
...
chroma_path = BACKEND_ROOT.parent / "vectorstore" / "chroma" / "chroma.sqlite3"
...
raw_data_path = BACKEND_ROOT.parent / "data" / "raw_data"
...
try:
    from app.experimental.rag.grounded_pipeline import GroundedRAGPipeline
...
try:
    from app.experimental.rag.fact_verifier import AnswerQualityController
...
try:
    from app.experimental.rag.hybrid_retrieval import HybridRetriever
...
try:
    from app.experimental.rag.ultimate_pipeline import UltimateRAGPipeline
